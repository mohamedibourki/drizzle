...
export declare function getOperators(): {
    ...
    eq: import("drizzle-orm/sql/expressions/conditions").BinaryOperator;
    exists: typeof exists;
    gt: import("drizzle-orm/sql/expressions/conditions").BinaryOperator;
    gte: import("drizzle-orm/sql/expressions/conditions").BinaryOperator;
    ilike: typeof ilike;
    inArray: typeof inArray;
    isNull: typeof isNull;
    isNotNull: typeof isNotNull;
    like: typeof like;
    lt: import("drizzle-orm/sql/expressions/conditions").BinaryOperator;
    lte: import("drizzle-orm/sql/expressions/conditions").BinaryOperator;
    ne: import("drizzle-orm/sql/expressions/conditions").BinaryOperator;
    not: typeof not;
...
export declare function createOne<TTableName extends string>(sourceTable: Table): <TForeignTable extends Table<import("drizzle-orm/table").TableConfig<Column<any, object, object>>>, TColumns extends [AnyColumn<{
    tableName: TTableName;
}>, ...AnyColumn<{
    tableName: TTableName;
...
export declare function createMany(sourceTable: Table): <TForeignTable extends Table<import("drizzle-orm/table").TableConfig<Column<any, object, object>>>>(referencedTable: TForeignTable, config?: {
    relationName: string;
...
export declare function createTableRelationsHelpers<TTableName extends string>(sourceTable: AnyTable<{
    ...
    one: <TForeignTable extends Table<import("drizzle-orm/table").TableConfig<Column<any, object, object>>>, TColumns extends [AnyColumn<{
        tableName: TTableName;
    }>, ...AnyColumn<{
        tableName: TTableName;
    }>[]]>(table: TForeignTable, config?: RelationConfig<TTableName, TForeignTable["_"]["name"], TColumns> | undefined) => One<TForeignTable["_"]["name"], Equal<TColumns[number]["_"]["notNull"], true>>;
    many: <TForeignTable_1 extends Table<import("drizzle-orm/table").TableConfig<Column<any, object, object>>>>(referencedTable: TForeignTable_1, config?: {
        relationName: string;
