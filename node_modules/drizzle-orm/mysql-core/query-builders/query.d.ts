...
import type { Mode, MySqlSession, PreparedQueryConfig, PreparedQueryHKTBase } from "drizzle-orm/mysql-core/session";
...
export declare class MySqlRelationalQuery<TPreparedQueryHKT extends PreparedQueryHKTBase, TResult> extends QueryPromise<TResult> {
    ...
    prepare(): import("drizzle-orm/utils").Assume<(TPreparedQueryHKT & {
        readonly config: PreparedQueryConfig & {
            execute: TResult;
        };
    })["type"], import("drizzle-orm/mysql-core/session").PreparedQuery<PreparedQueryConfig & {
        execute: TResult;
    }>>;
    private _getQuery;
    private _toSQL;
