...
import type { Mode, MySqlSession, MySqlTransaction, MySqlTransactionConfig, PreparedQueryHKTBase, QueryResultHKT, QueryResultKind } from "drizzle-orm/mysql-core/session";
...
export declare class MySqlDatabase<TQueryResult extends QueryResultHKT, TPreparedQueryHKT extends PreparedQueryHKTBase, TFullSchema extends Record<string, unknown> = {}, TSchema extends TablesRelationalConfig = ExtractTablesWithRelations<TFullSchema>> {
    ...
    with(...queries: WithSubquery[]): {
        ...
        update: <TTable extends MySqlTable<import("drizzle-orm/mysql-core/table").TableConfig>>(table: TTable) => MySqlUpdateBuilder<TTable, TQueryResult, TPreparedQueryHKT>;
        delete: <TTable_1 extends MySqlTable<import("drizzle-orm/mysql-core/table").TableConfig>>(table: TTable_1) => MySqlDeleteBase<TTable_1, TQueryResult, TPreparedQueryHKT, false, never>;
    };
    /**
