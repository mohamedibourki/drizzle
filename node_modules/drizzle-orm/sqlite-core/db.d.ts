...
export declare class BaseSQLiteDatabase<TResultKind extends 'sync' | 'async', TRunResult, TFullSchema extends Record<string, unknown> = Record<string, never>, TSchema extends TablesRelationalConfig = ExtractTablesWithRelations<TFullSchema>> {
    ...
    with(...queries: WithSubquery[]): {
        ...
        update: <TTable extends SQLiteTable<import("drizzle-orm/sqlite-core/table").TableConfig>>(table: TTable) => SQLiteUpdateBuilder<TTable, TResultKind, TRunResult>;
        insert: <TTable_1 extends SQLiteTable<import("drizzle-orm/sqlite-core/table").TableConfig>>(into: TTable_1) => SQLiteInsertBuilder<TTable_1, TResultKind, TRunResult>;
        delete: <TTable_2 extends SQLiteTable<import("drizzle-orm/sqlite-core/table").TableConfig>>(from: TTable_2) => SQLiteDeleteBase<TTable_2, TResultKind, TRunResult, undefined, false, never>;
    };
    /**
