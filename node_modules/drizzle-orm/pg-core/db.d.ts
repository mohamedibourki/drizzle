...
import type { PgSession, PgTransaction, PgTransactionConfig, QueryResultHKT, QueryResultKind } from "drizzle-orm/pg-core/session";
...
export declare class PgDatabase<TQueryResult extends QueryResultHKT, TFullSchema extends Record<string, unknown> = Record<string, never>, TSchema extends TablesRelationalConfig = ExtractTablesWithRelations<TFullSchema>> {
    ...
    with(...queries: WithSubquery[]): {
        ...
        update: <TTable extends PgTable<import("drizzle-orm/pg-core/table").TableConfig>>(table: TTable) => PgUpdateBuilder<TTable, TQueryResult>;
        insert: <TTable_1 extends PgTable<import("drizzle-orm/pg-core/table").TableConfig>>(table: TTable_1) => PgInsertBuilder<TTable_1, TQueryResult>;
        delete: <TTable_2 extends PgTable<import("drizzle-orm/pg-core/table").TableConfig>>(table: TTable_2) => PgDeleteBase<TTable_2, TQueryResult, undefined, false, never>;
    };
    /**
